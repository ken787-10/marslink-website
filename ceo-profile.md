      ...
      <div class="mb-12">
        <div class="lg:mx-auto flex flex-col w-full max-w-2xl mb-12 text-center">
          <img alt="CEO Profile" class="inline-block object-cover object-top w-32 h-32 sm:w-40 sm:h-40 mx-auto mt-8 mb-8 rounded-full border-4 border-gray-700/50 shadow-xl"
              src="{{ '/assets/images/kentaichii003.jpg' | relative_url }}" />
  ...
  <div class="bg-black py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        <h2 class="text-base/7 font-semibold text-indigo-400">Core Competencies</h2>
        <p class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-white sm:text-5xl lg:text-balance">専門領域</p>
        <p class="mt-6 text-lg/8 text-gray-300">学術研究と実務経験の両輪で、社会変革を加速する</p>
      </div>
